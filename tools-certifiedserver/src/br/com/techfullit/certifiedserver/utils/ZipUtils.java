...
public class ZipUtils {
	 ...
	 */
	public static void addFile(File arquivo, ZipOutputStream zos,
			File pastaPrincipal) throws IOException {
	...
	public static void unzip(File zipFile, File dir) throws Exception {
		System.out.println("Descompactando arquivo ["
				+ zipFile.getAbsolutePath() + "] para o diretorio ["
				+ dir.getAbsolutePath() + "]");
		ZipFile zip = null;
		File arquivo = null;
		InputStream is = null;
		...
		try {
			...
			while (e.hasMoreElements()) {
				...
				try {
					...
					System.out.println("Descompacatando: "
							+ arquivo.getAbsolutePath());
